...
public class AddendumBlocks {
	...
	public static final RegistryObject<Block> END_STONE_VERTICAL_SLAB = HELPER.createCompatBlock(Mods.QUARK, "end_stone_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.END_STONE)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> POLISHED_END_STONE_VERTICAL_SLAB = HELPER.createCompatBlock(Mods.QUARK, "polished_end_stone_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.END_STONE)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final RegistryObject<Block> PURPUR_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock(Mods.QUARK, "purpur_brick_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.PURPUR_BLOCK)), ItemGroup.BUILDING_BLOCKS);
	...
	// Midori
	public static final RegistryObject<Block> MIDORI_BRICKS = HELPER.createCompatBlock(Mods.QUARK, "midori_bricks", () -> new Block(Properties.MIDORI), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MIDORI_BRICK_SLAB = HELPER.createCompatBlock(Mods.QUARK, "midori_brick_slab", () -> new SlabBlock(Properties.MIDORI), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MIDORI_BRICK_STAIRS = HELPER.createCompatBlock(Mods.QUARK, "midori_brick_stairs", () -> new AbnormalsStairsBlock(MIDORI_BRICKS.get().getDefaultState(), Properties.MIDORI), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> MIDORI_BRICK_WALL = HELPER.createCompatBlock(Mods.QUARK, "midori_brick_wall", () -> new WallBlock(Properties.MIDORI), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> MIDORI_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock(Mods.QUARK, "midori_brick_vertical_slab", () -> new VerticalSlabBlock(Properties.MIDORI), ItemGroup.BUILDING_BLOCKS);
	
	public static final RegistryObject<Block> CHISELED_MIDORI_BRICKS = HELPER.createCompatBlock(Mods.QUARK, "chiseled_midori_bricks", () -> new Block(Properties.MIDORI), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> CACTUS_PASTE_BLOCK = HELPER.createCompatBlock(Mods.QUARK, "cactus_paste_block", () -> new Block(Block.Properties.from(Blocks.LIME_WOOL)), ItemGroup.DECORATIONS);
	
	// Himmel
	public static final RegistryObject<Block> HIMMEL_BRICKS = HELPER.createCompatBlock(Mods.OUTER_END, "himmel_bricks", () -> new Block(Block.Properties.from(Blocks.PURPUR_BLOCK)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HIMMEL_BRICK_SLAB = HELPER.createCompatBlock(Mods.OUTER_END, "himmel_brick_slab", () -> new SlabBlock(Block.Properties.from(Blocks.PURPUR_BLOCK)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HIMMEL_BRICK_STAIRS = HELPER.createCompatBlock(Mods.OUTER_END, "himmel_brick_stairs", () -> new AbnormalsStairsBlock(HIMMEL_BRICKS.get().getDefaultState(), Block.Properties.from(Blocks.PURPUR_BLOCK)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> HIMMEL_BRICK_WALL = HELPER.createCompatBlock(Mods.OUTER_END, "himmel_brick_wall", () -> new WallBlock(Block.Properties.from(Blocks.PURPUR_BLOCK)), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> HIMMEL_BRICK_VERTICAL_SLAB = HELPER.createCompatBlock("himmel_brick_vertical_slab", () -> new VerticalSlabBlock(Block.Properties.from(Blocks.PURPUR_BLOCK)), ItemGroup.BUILDING_BLOCKS, Mods.OUTER_END, Mods.QUARK);
	
	public static final RegistryObject<Block> CHISELED_HIMMEL_BRICKS = HELPER.createCompatBlock(Mods.OUTER_END, "chiseled_himmel_bricks", () -> new Block(Block.Properties.from(Blocks.PURPUR_BLOCK)), ItemGroup.BUILDING_BLOCKS);
	public static final RegistryObject<Block> FLORAL_PASTE_BLOCK = HELPER.createCompatBlock(Mods.OUTER_END, "floral_paste_block", () -> new Block(Block.Properties.from(Blocks.CYAN_WOOL)), ItemGroup.DECORATIONS);
